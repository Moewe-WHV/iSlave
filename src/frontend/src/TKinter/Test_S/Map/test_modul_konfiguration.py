class Farben:
    ...
    # ---- Bad ----
    BODEN_BAD = "#a3d9e8"        # helles Blau
    DUSCHE = "#00aadd"           # kräftiges Blau
    BADEWANNE = "#00aadd"        # gleiches Blau wie Dusche
    TOILETTE = "#bfbfbf"         # Hellgrau
    WASCHBECKEN = "#bfbfbf"      # Hellgrau
    WASCHMASCHINE = "#7a7a7a"    # Grau
    WAESCHETROCKNER = "#666666"  # dunkleres Grau

    # ---- Schlafzimmer ----
    BODEN_SCHLAFZIMMER = "#b9764a"  # Braun
    NACHTTISCH = "#ffffff"          # Weiß
    KLEIDERSCHRANK = "#ffffff"      # Weiß
    BETT = "#3f51b5"                # Blau

    # ---- Wohnzimmer ----
    BODEN_WOHNZIMMER = "#b9764a"  # Braun (wie Schlafzimmer-Boden)
    LADESTATION = "#e02b2b"       # Rot
    FERNSEHTISCH = "#ffffff"      # Weiß
    SOFA = "#3f51b5"              # Blau
